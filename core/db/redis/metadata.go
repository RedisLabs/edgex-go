...
func (c *Client) DeleteScheduleEvent(se models.ScheduleEvent) error {
	conn := c.Pool.Get()
	defer conn.Close()

	return deleteScheduleEvent(conn, se.Id.Hex())
}
...
func (c *Client) DeleteSchedule(s models.Schedule) error {
	conn := c.Pool.Get()
	defer conn.Close()

	return deleteSchedule(conn, s.Id.Hex())
}
...
func (c *Client) DeleteDeviceReport(dr models.DeviceReport) error {
	conn := c.Pool.Get()
	defer conn.Close()

	return deleteDeviceReport(conn, dr.Id.Hex())
}
...
func (c *Client) DeleteDevice(d models.Device) error {
	conn := c.Pool.Get()
	defer conn.Close()

	return deleteDevice(conn, d.Id.Hex())
}
...
func (c *Client) DeleteDeviceProfile(dp models.DeviceProfile) error {
	conn := c.Pool.Get()
	defer conn.Close()

	return deleteDeviceProfile(conn, dp.Id.Hex())
}
...
func (c *Client) DeleteAddressable(a models.Addressable) error {
	conn := c.Pool.Get()
	defer conn.Close()

	return deleteAddressable(conn, a.Id.Hex())
}
...
func (c *Client) DeleteDeviceService(ds models.DeviceService) error {
	conn := c.Pool.Get()
	defer conn.Close()

	return deleteDeviceService(conn, ds.Id.Hex())
}
...
func (c *Client) DeleteProvisionWatcher(pw models.ProvisionWatcher) error {
	conn := c.Pool.Get()
	defer conn.Close()

	return deleteProvisionWatcher(conn, pw.Id.Hex())
}
